...
class OtpPwrdReset extends StatefulWidget {
  const OtpPwrdReset({Key? key}) : super(key: key);

  @override
  State<OtpPwrdReset> createState() => _OtpPwrdResetState();
}

class _OtpPwrdResetState extends State<OtpPwrdReset> {
  String _tokenkey = '';
  String _password = '';
  ...
  void _otpchangePwrd() async {
    ...
    bool isregis = await Provider.of<OTPPWRDState>(
      context,
      listen: false,
    ).otpPwrdReset(
      _tokenkey,
                        ...
                        child: Center(
                          child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                  "Enter a new 8 to 12 digit password",
                                  style: TextStyle(
                                      fontSize: 16,
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          decoration: const InputDecoration(
                                            ...
                                            hintText: "Enter Your email token",
                                            hintStyle: TextStyle(
                                              fontSize: 16,
                                              color: Colors.black54,
                                              fontFamily: "GTWalsheimPro",
